                ...
                <div id="print-area" className="p-4 bg-white w-[300px] text-slate-600">
                    <div className="flex justify-between flex-col">
                        <div className="flex flex-col w-full">
                            <h1 className="text-sm font-bold text-center">{journal?.invoice}</h1>
                            <h1 className="text-xs font-bold text-center">{formatDateTime(journal?.date_issued)}</h1>
                        </div>
                        <div className="flex flex-col w-full mt-6">
                            <h1 className="text-sm text-center">Penambahan Saldo Kas</h1>
                            <h1 className="text-3xl font-bold text-center">{formatNumber(journal?.amount)}</h1>
                        </div>
                        <div className="flex flex-col w-full mt-6">
                            <h1 className="text-sm text-center">Tujuan</h1>
