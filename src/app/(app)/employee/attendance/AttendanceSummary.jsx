...
import { ArrowBigDown, ArrowBigUp, ChartNoAxesColumn, ChessQueen, Clock, Gift, Grid, List, Star } from "lucide-react";
...
const AttendanceSummary = ({ dateString, selectedZone }) => {
    ...
    return (
        <>
            ...
            {listMode ? (
                <AttendanceSummaryList employees={employees} search={search} selectedZone={selectedZone} checkUpOrDown={checkUpOrDown} />
            ) : (
