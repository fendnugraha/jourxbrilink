    ...
    return (
        <form>
            <div className="mb-4">
                ...
                <input type="text" name="name" required value={formData.name} onChange={handleChange} placeholder="Name" className="form-control" />
            ...
            <div className="grid grid-cols-2 gap-4 mb-4">
                <div>
                    ...
                    <select name="warehouse" required value={formData.warehouse} onChange={handleChange} className="form-select">
