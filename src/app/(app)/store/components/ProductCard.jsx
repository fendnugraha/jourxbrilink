...
const ProductCard = ({ product, onAddToCart }) => {
    return (
        <div className="group bg-white rounded-2xl px-4 py-4 shadow-md hover:border-indigo-300 border">
            <h1 className="text-xs font-bold group-hover:translate-x-4 transition-transform duration-300 ease-out ">{product.name}</h1>
