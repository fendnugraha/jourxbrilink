...
const ProductCard = ({ product, onAddToCart }) => {
    return (
        <div className="group hover:bg-yellow-100 dark:hover:bg-slate-600 border border-slate-200 dark:border-slate-600 flex justify-center gap-2 items-center bg-white dark:bg-slate-700 p-2 rounded-2xl hover:drop-shadow-xs">
