...
const CashBankBalanceOld = ({ accountBalance, dailyDashboard, isLoading, isValidating, mutateCashBankBalance, user }) => {
    ...
    console.log(accountBalance?.data?.chartOfAccounts);
    return (
        <div className="relative">
            ...
            <div className="flex justify-center items-center flex-col bg-gray-600 dark:bg-black/40 backdrop-blur-sm py-2 rounded-t-3xl text-white shadow-lg">
            ...
            >
                <div className="bg-gray-600 dark:bg-black/40 p-2">
                ...
                <div hidden={!showCashBankBalance} className="max-h-[calc(57px*7)] mt-1 overflow-y-scroll space-y-2">
                    {accountBalance?.data?.chartOfAccounts?.map((account) => (
                        <div className="group bg-gray-500/50 backdrop-blur-sm rounded-xl pt-2 px-4 shadow pb-1" key={account.id}>
                            <div className="flex justify-between items-center">
                                <h1 className="text-sm text-nowrap text-slate-500 font-bold">{account.account_group}</h1>

                                <div className="flex flex-col items-end">
                                    <h1 className="text-lg group-hover:scale-105 text-slate-500 dark:text-lime-300 font-semibold transition delay-100 duration-150 ease-out">
            ...
            <button
                ...
                className="bg-gray-400 dark:bg-black/40 backdrop-blur-sm hover:bg-gray-500 w-full pb-1 rounded-b-3xl shadow-md text-white disabled:bg-gray-100"
...
export default CashBankBalanceOld;
